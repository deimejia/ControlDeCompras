...
const productos = [
  {
    ...
    cantidad: 0,
    categoría: "panadería",
    id1: "panesDeHamburguesa",
  },
  {
    nombre: "Pan rústico",
    precio: 200,
    descripción: "Pan integral con semillas. Viene por 1 kg",
    cantidad: 0,
    categoría: "panadería",
    id1: "panRústico",
  },
  {
    nombre: "Babka de manzana",
    precio: 500,
    descripción: "Trenza rellena de manzana. Pesa aproximadamente 0.75 kg",
    cantidad: 0,
    categoría: "panadería",
    id1: "babkaDeManzana",
  },
  {
    nombre: "Bollos suizos",
    precio: 400,
    descripción: "Bollos azucarados. Vienen por docena",
    cantidad: 0,
    categoría: "panadería",
    id1: "bollosSuizos",
  },
  {
    nombre: "Pan lactal",
    precio: 250,
    descripción: "Pan de molde lactal. Viene por 1 kg",
    cantidad: 0,
    categoría: "panadería",
    id1: "panLactal",
  },
  {
    nombre: "Pan integral",
    precio: 350,
    descripción: "Pan de molde integral. Viene por 1 kg",
    cantidad: 0,
    categoría: "panadería",
    id1: "panIntegral",
  },
  {
    ...
    precio: 500,
    descripción:
      "Bizcochuelo de chocolate con relleno de buttercream y frutas. Viene por porción",
    cantidad: 0,
    categoría: "pastelería",
    id1: "tortaDeChocolate",
  },
  {
    nombre: "Berlinesas",
    precio: 300,
    descripción:
      "Facturas rellenas con dulce de leche o pastelera. Vienen por docena",
    cantidad: 0,
    categoría: "panadería",
    id1: "berlinesas",
  },
  {
    nombre: "Bundt cake",
    precio: 450,
    descripción: "Torta de vainilla y especias. Viene por unidad",
    cantidad: 0,
    categoría: "pastelería",
    id1: "bundtCake",
  },
];
const agregarACarritoInputArray = [
  document.getElementById("panesDeHamburguesa"),
  document.getElementById("panRústico"),
  document.getElementById("babkaDeManzana"),
  document.getElementById("bollosSuizos"),
  document.getElementById("panLactal"),
  document.getElementById("panIntegral"),
  document.getElementById("tortaDeChocolate"),
  document.getElementById("berlinesas"),
  document.getElementById("bundtCake"),
];
...
function agregarACarrito0(e) {
  ...
  function agregarACarrito1(id) {
    if (carrito.length == 0) {
      posiciónProducto1 = productos.findIndex(
        (nombreProducto) => nombreProducto.id1 == id
      );
      productos[posiciónProducto1].cantidad = parseInt(
        agregarProducto0.children[0].value
      );
      carrito.push(productos[posiciónProducto1]);
    } else {
      productoEncontrado = carrito.findIndex(
        (nombreProducto) => nombreProducto.id1 == id
      );
      productoEncontrado != -1
        ? ((posiciónProducto2 = carrito.findIndex(
            (nombreProducto) => nombreProducto.id1 == id
          )),
          (carrito[posiciónProducto2].cantidad += parseInt(
            agregarProducto0.children[0].value
          )))
        : ((posiciónProducto1 = productos.findIndex(
            (nombreProducto) => nombreProducto.id1 == id
...
function imprimirEnCarrito() {
  ...
  for (i = 0; i < carrito.length; i++) {
    cuerpoCarrito0.insertAdjacentHTML(
      "beforeend",
      `
...
function carritoSumar() {
  ...
  let idProducto1id = idProducto1.prototype.substring(
    12,
    idProducto1.length - 1
  );
